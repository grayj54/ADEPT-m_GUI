...
function UpdateSurRecoEdit(hObject, ~)
   bottom.sp = str2double( hObject.String)
   devObj.a_init_bc.ip(1).values = {bottom.sp};
end

function UpdateSurRecoElecEdit(hObject, ~)
    bottom.sn = str2double( hObject.String)
   devObj.a_init_bc.ip(2).values = {bottom.sn};

end

function UpdateMetWork(hObject,~)
   bottom.chi = str2double( hObject.String)
   devObj.a_init_bc.ip(9).values = {bottom.chi};
...
function UpdateShadowName(hObject,~)
   bottom.shadow = str2double( hObject.String)
   devObj.a_init_bc.ip(5).values = {bottom.sp};

    
end 
    function UpdateExternalRef(hObject,~)
    bottom.Rext = str2double( hObject.String)
   devObj.a_init_bc.ip(6).values = {bottom.ext};

    end


    function UpdateInternalRef(hObject,~)
    bottom.Rint = str2double( hObject.String)
   devObj.a_init_bc.ip(7).values = {bottom.sp};
