function hBuildMenu = openBuildMenu(devObj)
            ...
            function SavePress(~, ~)
                ...
                disp(['Temp Unit Selected: ' devObj.tempUnit]);
                disp(['Temp of Device: ' devObj.temp]);
                disp(['Desc of Device: ' devObj.desc]);
            ...
            function UpdateTempUnitSelected(hObject, ~)
                tuVal = hObject.Value;
                tuStr = hObject.String;
                devObj.tempUnit = tuStr{tuVal};
                disp(['Temp Unit Selected: ' devObj.tempUnit]);
            end
            
            function UpdateDesc(hObject, callbackdata)
                % Brings up new menu for selecting properties for the 
                % bottom of device
                
            end
            
            function UpdateTemp(hObject, callbackdata)
                % Brings up new menu for selecting properties for the 
                % bottom of device
